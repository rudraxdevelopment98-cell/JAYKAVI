...
export default function NotebookSidebar({ folders, activeFolderId, activeFilter, noteCounts }: Props) {
  ...
  return (
    <aside className="notebook-sidebar w-full md:w-56 flex-shrink-0 border-b border-neutral-800 md:border-b-0 md:border-r bg-neutral-900/30 p-4 md:min-h-full">
